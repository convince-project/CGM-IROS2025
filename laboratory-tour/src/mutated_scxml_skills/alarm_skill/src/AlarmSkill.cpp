...
bool AlarmSkill::start(int argc, char*argv[])
{
  ...
  m_stateMachine.connectToEvent("NotifyUserComponent.StopAlarm.Call", [this]([[maybe_unused]]const QScxmlEvent & event){
      ...
      std::shared_ptr<rclcpp::Client<notify_user_interfaces_dummy::srv::StopAlarm>> clientStopAlarm = nodeStopAlarm->create_client<notify_user_interfaces_dummy::srv::StopAlarm>("/NotifyUserComponent/StopAlarm");
      auto request = std::make_shared<notify_user_interfaces_dummy::srv::StopAlarm::Request>();
  ...
  m_stateMachine.connectToEvent("NotifyUserComponent.StartAlarm.Call", [this]([[maybe_unused]]const QScxmlEvent & event){
      ...
      std::shared_ptr<rclcpp::Client<notify_user_interfaces_dummy::srv::StartAlarm>> clientStartAlarm = nodeStartAlarm->create_client<notify_user_interfaces_dummy::srv::StartAlarm>("/NotifyUserComponent/StartAlarm_mon");
...
void AlarmSkill::halt( [[maybe_unused]] const std::shared_ptr<bt_interfaces_dummy::srv::HaltAction::Request> request,
